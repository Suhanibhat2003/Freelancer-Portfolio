...
function PortfolioEditor() {
  ...
  const tabs = ['Hero', 'About', 'Experience', 'Certifications', 'Contact', 'Customization'];
        ...
        <div className="flex border-b border-gray-200 mb-8">
          {tabs.map((tab) => (
            <button
              ...
              style={activeTab === tab ? { borderColor: '#4F3B78' } : {}}
            >
              {tab}
            </button>
          ))}
        ...
        <div className="space-y-8">
          ...
          {activeTab === 'Hero' && (
            ...
            <div className="space-y-4">
              ...
              {formData.hero.background?.type === 'image' && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    type="text"
                      value={formData.hero.background?.image || ''}
                      onChange={(e) => handleChange('hero', 'background', { ...formData.hero.background, image: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500"
                  ...
                  <div className="flex items-center mt-4">
                    <input
                      type="checkbox"
                      checked={formData.hero.background?.overlay}
                      onChange={(e) => handleChange('hero', 'background', { ...formData.hero.background, overlay: e.target.checked })}
                  ...
                  {formData.hero.background?.overlay && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Overlay Opacity
                      </label>
                      <input
                        ...
                        max="1"
                        step="0.1"
                        value={formData.hero.background?.overlayOpacity || 0.5}
                        onChange={(e) => handleChange('hero', 'background', { ...formData.hero.background, overlayOpacity: parseFloat(e.target.value) })}
                        className="w-full"
                      />
              </div>
                  )}
